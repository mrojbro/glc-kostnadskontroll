...
export type KrickosLegendCounts = {
  klarFaktJa: number;
  klarFaktNej: number;
...
export type KrickosLegendFilterKey = keyof KrickosLegendCounts;

export function rowMatchesKrickosLegend(
  row: KrickosRow,
  key: KrickosLegendFilterKey
): boolean {
...
const LEGEND_GROUPS: {
  ...
  sampleText: string;
  description: string;
  countKey: KrickosLegendFilterKey;
}[][] = [
  [
    {
...
interface KrickosColorLegendProps {
  counts: KrickosLegendCounts;
  activeFilter: KrickosLegendFilterKey | null;
  onFilterChange: (key: KrickosLegendFilterKey | null) => void;
}

export function KrickosColorLegend({
  counts,
  activeFilter,
  onFilterChange,
}: KrickosColorLegendProps) {
  return (
